...
const tracks = [
  ...
  {
    id: 1,
    number: "AI Cloud Master",
    title: "AWS Deployment ",
    titleColor: "text-orange-300",
    experience: "",
    description: "Deploying a machine learning model on AWS SageMaker for cloud-based inference.",
  },
  {
    id: 2,
    number: "AI Cloud Master",
    ...
    experience: "",
    description: "Using Terraform to set up AI infrastructure on AWS automatically.",
  },
  // {
  //   id: 3,
  //   number: "AI Cloud Master",
  ...
  // },
  {
    ...
    experience: "",
    description: "Tracking AI model performance using monitoring tools.",
  },
  ...
  <div className="max-w-5xl mx-auto">
    <div className="text-center mb-12">
      <h2 className="text-sm uppercase tracking-wider mb-2">AI Cloud Master Projects:</h2>
