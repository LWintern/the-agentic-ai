...
const AIRoadmap: React.FC = () => {
  ...
  const roadmapData: ModuleData[] = [
      ...
      capsules: [
        ...
        },
        {
          ...
          outcome: [
            ...
            "Music synthesis (e.g., Jukebox, MusicLM)"
          ],
          badge: "GenAI Innovator",
          icon: "🎨"
        },
      ...
      capsules: [
        {
          ...
          outcome: [
            ...
            "Bottleneck layer and dimensionality reduction",
        ...
        },
        {
          ...
          outcome: [
            ...
            "KL divergence and the reparameterization trick",
      ...
      capsules: [
        {
          ...
          outcome: [
            ...
            "Common architectures (DCGAN, StyleGAN)"
          ],
          badge: "GenAI Innovator",
          icon: "🤺"
        },
        ...
        },
        {
          name: "Simple GANs",
          outcome: [
            "Image synthesis on MNIST/CIFAR",
            "Evaluating GAN outputs (FID, IS)",
            "Transitioning to more complex datasets"
          ],
          badge: "GenAI Innovator",
          icon: "🎭"
        }
    ...
    {
      level: 4,
      title: "Self-Supervised Learning for Generative AI",
      capsules: [
        {
          name: "BERT-style Masked Modeling",
          outcome: [
        ...
        },
        {
          ...
          outcome: [
            ...
            "Applications in few-shot generation"
          ],
          badge: "GenAI Innovator",
          icon: "🔄"
        },
