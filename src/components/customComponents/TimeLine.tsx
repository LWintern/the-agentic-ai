            ...
            <div className="mb-8">
              {levelData.capsules.map((capsule, index) => (
                ...
                >
                  ...
                  <div className="font-bold text-3xl bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
  {capsule.name}
</div>
                  </h3>
                  ...
                  <p className="text-md md:text-lg font-medium mb-4 text-gray-300">
                    Duration: {capsule.duration} <span className="px-2 ml-20 bg-gray-800 gradient-border">Price: ₹ {capsule.price}</span>
                  </p>
