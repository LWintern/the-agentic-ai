...
const tracks = [
  // First 4 tracks with specific colors as requested
  {
    ...
    experience: "",
    description: "Recognize handwritten digits (0-9) using a Convolutional Neural Network (CNN).",
  },
  {
    id: 2,
    number: "Deep Learning Pro",
    ...
    experience: "",
    description: "Classify emails as spam or not spam using a Recurrent Neural Network (RNN).",
  },
  {
    id: 3,
    number: " Deep Learning Pro",
    ...
    experience: "",
    description: "Predict future stock prices using Long Short-Term Memory (LSTM) networks.",
  },
  {
    id: 4,
    number: " Deep Learning Pro",
    ...
    experience: "",
    description: "Perform sentiment analysis on movie reviews using Long Short-Term Memory (LSTM) networks.",
  },
