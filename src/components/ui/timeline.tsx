...
//   return (
//     <div
//       className="w-full max-w-5xl mx-auto bg-white dark:bg-neutral-950 font-sans md:px-10"
//       ref={containerRef}
//     >
//       <div className="max-w-5xl mx-auto py-6 px-4 md:px-8 lg:px-10">
//         <h2 className="text-2xl md:text-4xl mb-2 text-center  text-black dark:text-white max-w-4xl font-bold">
//           My AI Learning Journey: A Timeline of Progress and Achievements
//         </h2>
//         <p className="text-neutral-700 dark:text-neutral-300 mx-auto text-center text-sm md:text-base max-w-lg">
