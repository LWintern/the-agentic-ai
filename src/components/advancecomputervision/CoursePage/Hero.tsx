...
export default function Hero() {
  return (
    <div className="relative w-full min-h-[80vh] md:min-h-[50vh] overflow-x-hidden bg-[linear-gradient(to_bottom_right,#8b2fd3CC_0%,#040106_30%,#040106_70%,#ca2571CC_100%)]">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 pt-24 md:pt-24 pb-20 md:pb-20 min-h-[80vh] md:min-h-[50vh] flex flex-col justify-center">
        ...
        {/* CTA Button */}
        <a href="https://rzp.io/rzp/yl3TTvM" target="_blank" rel="noopener noreferrer" className="block w-full sm:w-auto">
          <Button
            variant="outline"
