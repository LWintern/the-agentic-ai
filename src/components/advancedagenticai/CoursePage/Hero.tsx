...
export default function Hero() {
  return (
    <div className="relative w-full min-h-[80vh] md:min-h-[50vh] bg-[linear-gradient(to_bottom_right,#8b2fd3CC_0%,#040106_25%,#040106_75%,#ca2571CC_100%)]">
      ...
      <div className="relative mx-auto max-w-6xl px-4 md:px-6 pt-24 md:pt-24 pb-20 md:pb-20 min-h-[80vh] md:min-h-[50vh] flex flex-col justify-center">
        {/* Main heading */}
        ...
        {/* CTA Button */}
        <a href="https://rzp.io/rzp/lOLC1zs" target="blank" className="block w-full sm:w-auto">
          <Button
            variant="outline"
