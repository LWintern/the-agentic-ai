...
const tracks = [
  ...
  // Continuing with all remaining tracks (5-43)
  {
    ...
    titleColor: "text-orange-300",
    experience: "",
    description: "An AI-powered fact-checking agent that analyzes news articles, verifies claims, and detects bias.",
  },
  {
    id: 6,
    number: "Agentic AI Specialist",
    ...
    titleColor: "text-purple-300",
    experience: "",
    description: "An AI-powered tutor that adapts to a student’s learning style and creates custom study plans.",
  },
  {
    id: 7,
    number: "Agentic AI Specialist",
    ...
    titleColor: "text-green-300",
    experience: "",
    description: "An AI-driven resume builder that analyzes job descriptions, tailors applications, and tracks interviews.",
  },
  {
    id: 8,
    number: "08",
    ...
    titleColor: "text-amber-300",
    experience: "",
    description: "An AI-powered content creation agent that writes blog posts, generates ads, and optimizes SEO.",
  },
  // {
  //   id: 9,
  //   number: "09",
  ...
  <div className="max-w-5xl mx-auto">
    <div className="text-center mb-12">
      <h2 className="text-sm uppercase tracking-wider mb-2">Agentic AI Specialist Projects:</h2>
